  ...
  return (
    <button
      ...
      className={cn(
        ...
        isAbsent ? 'bg-red-50' : 'hover:bg-muted/50'
      )}
    >
      <div
        className={cn(
          'w-5 h-5 rounded-full border-2 flex-shrink-0 flex items-center justify-center',
          isAbsent ? 'border-red-500 bg-red-500' : 'border-green-500 bg-green-500'
        )}
      >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          <span className={cn('font-medium text-sm truncate', isAbsent && 'text-red-700')}>
            {student.full_name}
          </span>
